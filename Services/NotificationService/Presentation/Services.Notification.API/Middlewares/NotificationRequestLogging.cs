...
namespace Services.Notification.API.Middlewares
{
    public static class NotificationRequestLogging
    {
        public static IApplicationBuilder UseNotificationRequestLogging(this IApplicationBuilder app)
        {
