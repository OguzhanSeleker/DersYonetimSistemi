...
{
    public class QuestionContentReadRepository : ReadRepository<QuestionContent>, IQuestionContentReadRepository
    {
        public QuestionContentReadRepository(SurveyServiceDbContext context) : base(context)
        {
        }
    }
}
