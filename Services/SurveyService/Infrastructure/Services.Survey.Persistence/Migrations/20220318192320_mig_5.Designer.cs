...
namespace Services.Survey.Persistence.Migrations
{
    ...
    [Migration("20220318192320_mig_5")]
    partial class mig_5
    {
            ...
            modelBuilder.Entity("Services.Survey.Domain.Entities.Answer", b =>
                {
                    ...
                    b.Property<Guid>("QuestionContentId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Services.Survey.Domain.Entities.Answer", b =>
                {
                    ...
                    b.HasOne("Services.Survey.Domain.Entities.QuestionContent", "QuestionContent")
                        .WithMany()
                        .HasForeignKey("QuestionContentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
