...
namespace Services.Lesson.API.Middlewares
{
    public static class LessonRequestLogging
    {
        public static IApplicationBuilder UseLessonRequestLogging(this IApplicationBuilder app)
        {
