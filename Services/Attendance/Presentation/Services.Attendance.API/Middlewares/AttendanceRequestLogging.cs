...
namespace Services.Attendance.API.Middlewares
{
    public static class AttendanceRequestLogging
    {
        public static IApplicationBuilder UseAttendanceRequestLogging(this IApplicationBuilder app)
        {
            return app.UseSerilogRequestLogging(options =>
            {
                ...
                options.EnrichDiagnosticContext = (diagnosticContext, httpContext) =>
                {
                    ...
                    if (user != null && user.IsAuthenticated)
                    {
                        ...
                        //var email = ci?.Claims.FirstOrDefault(a => a.Type =="Username")?.Value;
