...
namespace Services.Message.API.Middlewares
{
    public static class MessageRequestLogging
    {
        public static IApplicationBuilder UseMessageRequestLogging(this IApplicationBuilder app)
        {
