...
namespace Services.FileSystem.API.Middlewares
{
    public static class FileSystemRequestLogging
    {
        public static IApplicationBuilder UseFileSystemRequestLogging(this IApplicationBuilder app)
        {
